var chai = require('chai')
    , Strategy = require('passport-jwt/lib/strategy')
    , test_data = require('passport-jwt/test/testdata')
    , sinon = require('sinon')
    , verify = require('passport-jwt/lib/verify_jwt')
    , extract_jwt = require('passport-jwt/lib/extract_jwt');
